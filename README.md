...
Retrieves a [#datatore] with the given id, if no matching datastore could be found, then null is returned in the callback.
...
#### list([opts,] callback)
Retrieves an array of all available [#datastore]s.
