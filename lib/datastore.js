...
module.exports.prototype.pull = function(callback) {
    ...
    var request;
    if (this.rev === 0) {
        request = new this._manager._ApiRequest('POST','get_snapshot',this._manager.apiToken);
        ...
        request = new this._manager._ApiRequest('POST','get_deltas',this._manager.apiToken);
