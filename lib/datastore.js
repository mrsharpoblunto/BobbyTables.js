...
module.exports.prototype.pull = function(callback) {
    ...
    var self = this;
    if (this.rev === 0) {
        var request = new ApiRequest('POST','get_snapshot',this._manager.apiToken);
        ...
        var request = new ApiRequest('POST','get_deltas',this._manager.apiToken);
...
module.exports.prototype.awaitPull = function(callback)
{
    ...
    var request= new ApiRequest('GET','await?get_deltas=' + encodeURIComponent(JSON.stringify(args)));
...
module.exports.prototype.push = function(callback) {
    ...
    var self = this;
    var request = new ApiRequest('POST','put_delta',this._manager.apiToken);
    request.addParam('handle',this.handle).addParam('rev',this.rev).addParam(JSON.stringify(args));
    request.getResponse(function(err,response) {
        if (err) {
            callback(err,null);
            return;
