...
module.exports = function(apiToken,opts)
{
    ...
    if (opts) {
        ApiRequest = opts.ApiRequest || ApiRequest;
    }
...
module.exports.prototype.get = function(id,opts,callback)
{
    ...
    if (!store || ops.forceRefresh) {
        var request = new ApiRequest("POST","get_datastore", this._apiToken);
...
module.exports.prototype.list = function(opts,callback)
{
    ...
    if (!this._token || opts.forceRefresh) {
        var request = new ApiRequest("POST","list_datastores",this.apiToken);
        var self = this;
        request.getResponse(function(err,response) {
            try
            {
                ...
                var datastores = response.body.datastores;
...
module.exports.prototype._listDatastores = function(datastores)
{
    this._datastores = {};
    this._token = response.body.token;
    var newStore = null;
    for (var key in datastores) {
        var datastore = datastores[key];
...
module.exports.prototype.awaitListChanges = function(callback) {
    ...
    var request = new ApiRequest("GET",url,this.apiToken);
    request.getResponse(function(err,response) {
        if (err) {
            callback(err,null);
            return;
...
module.exports.prototype.awaitDatastoreChanges = function(callback) {
    ...
    this.list(function(err,datastores) {
        ...
        var request = new ApiRequest('GET',url,self.apiToken);
        request.getResponse(function(err,response) {
            if (err) {
                callback(err,null);
                return;
...
module.exports.prototype.getOrCreate = function(id,opts,callback)
{
    ...
    if (!store || opts.forceRefresh) {
        var request = new ApiRequest('POST','get_or_create_datastore',this.apiToken);
        request.addParam('dsid',id);
        request.getResponse(function(err,response) {
            if (err) {
                callback(err,null);
...
module.exports.prototype.create = function(key,callback)
{
    ...
    var self = this;
    var request = new ApiRequest('POST','create_datastore', this.apiToken);
